let todos = [];
        ...
        async function fetchQuote() {
            try {
                quoteContainer.innerHTML = '<p class="quote-loading">Loading inspiration...</p>';
                ...
                quoteContainer.innerHTML = '<p class="quote-loading">Unable to load quote. Click to try again.</p>';
            }
        }
